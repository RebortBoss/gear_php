...
/**
 * Interface for a build for the required range of iterator classes
...
interface IIteratorScheme
{
     ...
     * implementation from the supplied build.
     *
     * @param \Traversable $iterator
     ...
     * outer element will be wrapped in a traversable implementation from the supplied build.
     *
     * @param \Traversable $outerIterator
     * @param \Traversable $innerIterator
     * @param callable     $traversableFactory
