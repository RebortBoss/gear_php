...
class Image
{
    ...
    /**
     * 设置图片来源
     * @param $img_file string path
     * @param $status int 状态
     */
    public function __construct($img_file, $status = 0)
    {
        $this->img    = $img_file;
        $this->status = $status;
        $this->ext=\Yuri2::getExtension($img_file);
    }
     ...
     * @author yuri2
     * */
    public static function makeDir($path, $mode = 0775)
    {
